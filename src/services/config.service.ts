...
export async function configAI(): Promise<void> {
    try {
        ...
        logger.info(`✅ AI provider configured successfully: ${AI_PROVIDERS[provider as AIProvider].name}`);
        console.log(`✅ AI provider configured successfully: ${AI_PROVIDERS[provider as AIProvider].name}`);
    } catch (err) {
