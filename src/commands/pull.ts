...
export async function pull(): Promise<void> {
    ...
    const { schemaData, localSchemaHash, lastPullTime } = await getLocalSchemaInfo(schemaFile, lastPullTimeFile);
    ...
    if (!projectCredentials) {
        ...
        console.error(chalk.red("❌ Failed to get project information. Please check your project configuration."));
        return;
    }
